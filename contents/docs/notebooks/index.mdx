...
## Sharing notebooks externally

You can share notebooks publicly with people outside your organization – no PostHog login required. This is great for sharing analysis with external stakeholders, clients, or partners.

To share a notebook externally:

1. Open your notebook and click the **share icon** at the top
2. Enable **Share externally**
3. Copy the public link

External viewers see a read-only version. Shared notebooks support:

- Text and formatting
- Embedded iframes
- Insights (trends, funnels, retention, etc.)
- Data tables (events and persons)
- SQL queries

You can also add password protection for extra security.
...
You can also [share notebooks externally](#sharing-notebooks-externally) with people outside your organization.

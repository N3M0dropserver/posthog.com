...
If your organization has multiple PostHog projects, you can copy team-scoped dashboard templates between them. This lets you reuse custom templates across environments like staging and production, or share them with other teams.

To copy a template to another project:

1. Go to **Dashboards** and select the **Templates** tab.
2. Find the template you want to copy and click its **⋯** menu.
3. Select **Copy to another project**.
4. Choose the destination project from the dropdown.
5. Click **Copy**.

The original template remains unchanged. Each copy is independent—editing one does not affect the other.

> **Note:** The copy option only appears for team-scoped templates when your organization has more than one project.
